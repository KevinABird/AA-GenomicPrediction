...
phenotypes$Taxa <- paste("A", phenotypes$Taxa, sep="") # append 'A' to taxa names
...
# creating the Wlist works... unsure about fnRaw option (see qgg documentation - should be able to construct W and G from this command)
Wlist <- prepW(bedfiles="./data/GS_subset/plinkGeneOmeSubset.bed",
...
Wlist$ids <- paste("A", Wlist$ids, sep="") 
