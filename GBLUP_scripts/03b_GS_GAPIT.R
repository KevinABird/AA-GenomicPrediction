...
KI <-read.csv("/home/birdk/data/GeneOme/GAPIT.Kin.VanRaden.csv", head=FALSE)



t=1000 #total replicates
...
write.table(storage, file=sprintf("GS_%s_GAPIT.Cross.Validation.txt",colnames(AAabs)[2]), quote = FALSE, sep = "\t", row.names = TRUE,col.names = NA)
